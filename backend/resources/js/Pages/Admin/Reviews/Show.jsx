              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
                  <input
                    ...
                    onChange={(e) =>
                      setFormData((prev) => ({ ...prev, is_approved: e.target.checked }))
                    }
                ...
                <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
                  <input
                    ...
                    onChange={(e) =>
                      setFormData((prev) => ({ ...prev, is_verified_purchase: e.target.checked }))
                    }
                    className="w-5 h-5 text-forest-green rounded focus:ring-forest-green border-gray-300"
                  />
                  <label
                    htmlFor="is_verified_purchase"
                    className="text-sm font-bold text-gray-700 cursor-pointer"
                  >
                    Achat vérifié
                  </label>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="font-bold text-gray-900">
                    {review.product?.name || 'Avis Boutique'}
                  </p>
                </div>
                {review.product && (
                  <Link
