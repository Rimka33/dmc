                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p className="font-semibold text-gray-900">{product.category?.name || 'Non classé'}</p>
                                    </div>
                                    <div>
                                        <p className="text-sm text-gray-500">Tags</p>
                                        <div className="flex flex-wrap gap-2 mt-1">
                                            {product.tags && JSON.parse(product.tags).map((tag, i) => (
                            ...
                            <div className="space-y-4">
                                ...
                                {product.discount_price && (
                                    <div className="flex justify-between items-center py-2 border-b border-gray-100">
                                        ...
                                        <span className="font-bold text-red-600 text-lg">{formatCurrency(product.discount_price)}</span>
                                    </div>
                                )}
                                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                                    <span className="text-gray-600">En stock</span>
                                    <span className={`font-bold ${product.stock_quantity > 10 ? 'text-green-600' : 'text-orange-500'}`}>
