          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 text-center">
              ...
              <p className="text-sm text-gray-600">
                Créez vos premières collections pour organiser vos produits sur la page d'accueil
              </p>
            </div>
                ...
                {[
                  {
                    ...
                    description: 'Mettez en avant vos meilleurs produits',
                  },
                  {
                    type: 'new',
                    label: 'Nouveautés',
                    ...
                    description: 'Affichez vos nouveaux produits',
                  },
                  {
                    type: 'special_offers',
                  ...
                  return (
                    <Link
                      ...
                      href={
                        existingCollection
                          ? `/admin/collections/${existingCollection.id}/edit`
