        ...
        <AdminLayout>
            <div className="max-w-4xl mx-auto space-y-6 pb-12">
                <PageHeader
                    ...
                    subtitle="Création d'un nouveau compte utilisateur"
                    breadcrumbs={['Utilisateurs', 'Ajouter']}
                >
                    <Link
                        href="/admin/users"
                    ...
                    <Section title="Sécurité & Accès">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                {errors.role_id && <p className="text-xs text-red-500 font-bold mt-1">{errors.role_id}</p>}
