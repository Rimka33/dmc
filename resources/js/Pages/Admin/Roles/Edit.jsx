        ...
        <AdminLayout>
            <div className="max-w-5xl mx-auto space-y-6 pb-12">
                <PageHeader
                    ...
                    subtitle={`Modification du niveau d'accès : ${role.name}`}
                    breadcrumbs={['Rôles', role.name, 'Modifier']}
                    action={
                        <Link
                            href="/admin/roles"
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Section title="Permissions">
                                ...
                                <div key={group} className="bg-gray-50/50 p-6 rounded-2xl border border-gray-100">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                        {groupPermissions.map(perm => (
                                            <label key={perm.id} className="flex items-start gap-3 p-3 bg-white rounded-xl border border-gray-100 cursor-pointer hover:border-forest-green/30 transition-all group">
                        ...
                        {errors.permissions && <p className="text-sm text-red-500 font-bold mt-4">{errors.permissions}</p>}
                    </Section>
                    ...
                    <div className="flex justify-end pt-6">
                        ...
                        >
                            <Save size={20} />
                            {processing ? 'Enregistrement...' : 'Mettre à jour le Rôle'}
                        </button>
                    </div>
                </form>
            </div>
