...
import { User, Mail, AtSign, Lock, CheckCircle2, Phone, MapPin, Map, Globe, AlertCircle } from 'lucide-react';
...
export default function UserDashboard() {
    ...
    const handlePasswordUpdate = async (e) => {
        ...
        try {
            ...
            setStatus({ type: 'error', message: error.response?.data?.message || 'Erreur lors du changement de mot de passe.' });
        } finally {
            setUpdating(false);
            setTimeout(() => setStatus({ type: '', message: '' }), 5000);
        }
            ...
            <div className="container mx-auto px-4 py-12">
                <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-8">
                    ...
                    <aside className="lg:w-1/4">
                        <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/40 border border-gray-100 p-6 sticky top-28">
                            <div className="flex items-center gap-4 mb-8 pb-6 border-b border-gray-50">
                                ...
                                <div>
                                    <p className="text-sm font-black text-gray-900 truncate max-w-[150px]">{user.name}</p>
                    ...
                    <div className="lg:w-3/4">
                        {status.message && (
                            <div className={`mb-6 p-4 rounded-2xl flex items-center gap-3 animate-in fade-in slide-in-from-top-4 duration-300 ${status.type === 'success' ? 'bg-green-50 text-green-700 border border-green-100' : 'bg-red-50 text-red-700 border border-red-100'
                                }`}>
                        ...
                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            ...
                            <div className="bg-white p-8 md:p-10 rounded-[2.5rem] shadow-xl shadow-gray-200/30 border border-gray-100">
                                <div className="flex items-center gap-3 mb-8">
                                    ...
                                    <h3 className="text-xl font-black text-gray-900 uppercase italic tracking-tighter">Informations <span className="text-forest-green">Personnelles</span></h3>
                                </div>
                                ...
                                <form onSubmit={handleProfileUpdate} className="space-y-8">
                                    ...
                                    <div className="pt-6 border-t border-gray-100">
                                        <div className="flex items-center gap-3 mb-6">
                                            ...
                                            <h4 className="text-xs font-black text-gray-900 uppercase tracking-widest">Coordonnées de livraison</h4>
                                        </div>
                            ...
                            <div className="bg-white p-8 md:p-10 rounded-[2.5rem] shadow-xl shadow-gray-200/30 border border-gray-100">
                                <div className="flex items-center gap-3 mb-8">
                                    ...
                                    <h3 className="text-xl font-black text-gray-900 uppercase italic tracking-tighter">Sécurité <span className="text-forest-green">du Compte</span></h3>
                                </div>
