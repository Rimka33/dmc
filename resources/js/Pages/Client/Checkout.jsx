      ...
      <div className="relative h-56 bg-black overflow-hidden">
        ...
        <div className="container mx-auto px-4 h-full flex flex-col items-center justify-center relative z-10">
          ...
          <div className="flex items-center gap-2 text-white/70 text-sm">
            ...
            <span>/</span>
            <Link to="/panier" className="hover:text-neon-green transition-colors">
              Panier
            </Link>
            <span>/</span>
          ...
          {!authenticated && (
            <div className="max-w-7xl mx-auto mb-8">
              <div className="bg-blue-50 border-l-4 border-blue-500 p-5 rounded-r-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <Link
                  to="/mon-compte"
                  className="px-6 py-3 bg-blue-500 text-white font-bold rounded-lg hover:bg-blue-600 transition-all text-center whitespace-nowrap"
                >
                  SE CONNECTER
                </Link>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
                  ...
                  {deliveryMethod === 'pickup' && (
                    <div className="mb-8 p-4 bg-green-50 border-2 border-green-100 rounded-xl flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-900 mb-1 uppercase text-sm">
                          Récupération au Showroom DMC
                        </h4>
                        <p className="text-xs text-gray-600 leading-relaxed">
                          345 Rue FA 22, Dakar, Sénégal
                          <br />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      {errors.customer_phone && (
                        <p className="text-red-500 text-xs mt-1">{errors.customer_phone[0]}</p>
                      )}
                    </div>
                        ...
                        {authenticated ? (
                          <div className="space-y-4">
                            <label className="flex items-center gap-3 cursor-pointer group">
                              <div
                                className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all ${formData.ship_to_different_address ? 'border-gray-300' : 'border-forest-green bg-forest-green'}`}
                              >
                            ...
                            <label className="flex items-center gap-3 cursor-pointer group mt-4">
                              <div
                                className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all ${formData.ship_to_different_address ? 'border-forest-green bg-forest-green' : 'border-gray-300'}`}
                              >
                                {formData.ship_to_different_address && (
                                  <div className="w-2 h-2 rounded-full bg-white"></div>
                                )}
              ...
              <div className="lg:col-span-1">
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sticky top-24">
                  <h3 className="text-sm font-black text-gray-900 uppercase mb-6 pb-4 border-b">
                    Votre commande
                  </h3>
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <div className="max-h-64 overflow-y-auto space-y-3">
                      {cart.items.map((item, index) => (
                        <div
                          key={`checkout-item-${item.id || item.product_id || index}`}
                        ...
                        >
                          <div className="flex items-center gap-2 flex-1 min-w-0">
                            ...
                            <span className="text-xs font-medium text-gray-700 line-clamp-2">
                              {item.name}{' '}
                              <span className="text-forest-green">× {item.quantity}</span>
                            </span>
                          </div>
