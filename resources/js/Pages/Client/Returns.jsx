        ...
        <div className="container mx-auto px-4 max-w-4xl">
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="text-gray-500 mb-8">
                Désolé, cette page n'est pas accessible pour le moment.
              </p>
              <Link
                to="/"
          ...
          <div className="p-8 rounded-2xl bg-forest-green text-white text-center">
            ...
            <p className="font-medium opacity-90 mb-8 max-w-xl mx-auto text-sm">
              Contactez notre service client par téléphone au{' '}
              <span className="font-black">+221 77 236 77 77</span> ou rendez-vous directement dans
              notre showroom avec votre facture.
            </p>
            <Link
              to="/contact"
              className="inline-block px-8 py-4 bg-white text-forest-green font-black uppercase rounded-sm hover:bg-neon-green hover:text-black transition-all"
            >
              Nous contacter
            </Link>
          </div>
