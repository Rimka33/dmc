              ...
              <form onSubmit={handleLoginSubmit} className="space-y-5">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <label
                      htmlFor="remember"
                      className="text-gray-600 text-sm cursor-pointer hover:text-gray-900 font-medium"
                    >
                      Souviens-toi de moi
                    </label>
                  </div>
                  ...
                  <Link
                    to="/forgot-password"
                    size="sm"
                    className="text-forest-green text-sm hover:underline font-semibold"
                  >
                    Mot de passe oublié ?
                  </Link>
                </div>
              ...
              <form onSubmit={handleRegisterSubmit} className="space-y-4">
                ...
                <div className="bg-gray-50 p-5 rounded border border-gray-100 mt-4">
                  <p className="text-gray-500 text-xs leading-relaxed mb-4">
                    Vos données personnelles seront utilisées pour soutenir votre expérience sur ce
                    site Web, pour gérer l'accès à votre compte et à d'autres fins décrites dans
                    notre{' '}
