                    ...
                    <div className="max-w-4xl mx-auto">
                        {loading ? (
                            ...
                            <div className="text-center py-20">
                                <h2 className="text-xl font-black text-gray-900 uppercase mb-4">Page non trouvée</h2>
                                <p className="text-gray-500 mb-8">Désolé, le contenu que vous recherchez n'est pas disponible pour le moment.</p>
