        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <div className="max-w-3xl mx-auto">
            <h1 className="text-2xl md:text-3xl font-black text-white uppercase mb-4 leading-tight">
              {page?.title || 'Termes &'}{' '}
              <span className="text-neon-green">{!page ? 'Conditions' : ''}</span>
            </h1>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-16 p-8 rounded-2xl bg-forest-green text-white">
              ...
              <p className="font-medium opacity-90 mb-6">
                Notre équipe est à votre disposition pour vous éclairer sur nos conditions ou pour
                toute autre demande concernant vos achats chez DMC.
              </p>
              <Link
                to="/contact"
