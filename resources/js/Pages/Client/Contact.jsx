          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-8">
              ...
              <p className="text-gray-400 text-sm font-medium mb-12">
                Veuillez saisir les détails de votre demande. Un membre de notre équipe d'assistance
            ...
            <div className="lg:col-span-4 space-y-8 pt-12 lg:pt-24">
              <div className="space-y-6">
                ...
                <div className="space-y-1">
                  <p className="text-sm font-black text-gray-900">
                    Courriel :{' '}
                    <span className="font-medium text-gray-400">contact@dmcomputer.sn</span>
                  </p>
                  <p className="text-sm font-black text-gray-900">
                    Appelez-nous :{' '}
                    <span className="font-medium text-gray-400">
                      (+221) 77 236 77 77 / 77 430 44 44
                    </span>
                  </p>
                </div>
                ...
                <div className="space-y-1">
                  <p className="text-sm font-black text-gray-900">
                    ...
                    <span className="font-medium text-gray-400">
                      Notre magasin ouvre ses portes du Lundi au Samedi de{' '}
                      <span className="text-gray-900 font-black">09h à 20h.</span>
                    </span>
                  </p>
                </div>
              </div>
            ...
            {loadingMessages ? (
              ...
              <div className="space-y-8">
                {userMessages.map((msg) => (
                  <div
                    key={msg.id}
                    className="bg-white rounded-[2rem] shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500"
                  >
                    <div className="p-8">
                        ...
                        <div className="space-y-3">
                          ...
                          {msg.reply ? (
                            ...
                            <div className="p-6 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center text-center">
                              ...
                              <p className="text-gray-400 font-bold text-xs italic">
                                Notre équipe examine votre message...
                              </p>
                            </div>
                          )}
                        </div>
              ...
              <div className="bg-white rounded-[2rem] p-16 text-center border-2 border-dashed border-gray-200">
                ...
                <h3 className="text-xl font-black text-gray-300 uppercase italic">
                  Aucun message envoyé
                </h3>
                <p className="text-gray-400 font-medium mt-2">
                  Utilisez le formulaire ci-dessus pour nous contacter.
                </p>
              </div>
            )}
          </div>
