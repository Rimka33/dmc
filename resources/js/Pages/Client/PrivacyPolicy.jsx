            ...
            <div className="prose prose-sm max-w-none">
              ...
              <div className="mt-12 bg-gray-50 p-8 rounded-3xl border border-gray-100">
                ...
                <p className="text-gray-600 font-medium leading-relaxed mb-6 italic text-sm">
                  ...
                  données personnelles. Vous pouvez exercer ce droit à tout moment depuis votre
                  espace client ou en nous contactant.
                </p>
                <Link
                  to="/mon-compte"
                  className="text-forest-green font-black uppercase text-[10px] tracking-widest hover:text-neon-green transition-colors flex items-center gap-2"
                >
