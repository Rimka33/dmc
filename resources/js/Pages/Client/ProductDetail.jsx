        ...
        try {
            ...
            if (productData) {
                const relatedResponse = await api.get('/products', {
                    params: {
                        category_id: productData.category?.data?.id || productData.category?.id || productData.category_id,
                        per_page: 5
                    }
                });
                        ...
                        <div className="flex flex-col h-full">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-start gap-3 p-3 border border-gray-100 rounded-lg">
                                    <div className="mt-0.5 text-gray-400"><Truck className="w-5 h-5" /></div>
                                    <div>
                                ...
                                <div className="flex items-start gap-3 p-3 border border-gray-100 rounded-lg">
                                    <div className="mt-0.5 text-gray-400"><RotateCcw className="w-5 h-5" /></div>
                                    <div>
                                        <p className="text-xs font-bold text-gray-900 uppercase">Retours Gratuits</p>
                                        <p className="text-[11px] text-gray-500 mt-0.5">Sur toute commande supérieure à 50.000 FCFA</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-8 pt-6 border-t border-gray-100 text-[10px] text-gray-400 uppercase tracking-widest space-y-2">
                                <p>SKU: <span className="text-gray-600 font-bold">{product.sku}</span></p>
                                <p>Catégorie: <span className="text-gray-600 font-bold">{product.category?.name}</span></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="flex gap-8 border-b border-gray-200 mb-8 overflow-x-auto">
                            <button
                                ...
                                className={`pb-3 px-2 border-b-2 font-black uppercase text-sm tracking-widest transition-colors whitespace-nowrap ${activeTab === 'description'
                            ...
                            <button
                                ...
                                className={`pb-3 px-2 border-b-2 font-black uppercase text-sm tracking-widest transition-colors whitespace-nowrap ${activeTab === 'specifications'
                                    ? 'border-forest-green text-gray-900'
                                    : 'border-transparent text-gray-400 hover:text-gray-600'
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`pb-3 px-2 border-b-2 font-black uppercase text-sm tracking-widest transition-colors whitespace-nowrap ${activeTab === 'reviews'
                                    ? 'border-forest-green text-gray-900'
                                    : 'border-transparent text-gray-400 hover:text-gray-600'
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`pb-3 px-2 border-b-2 font-black uppercase text-sm tracking-widest transition-colors whitespace-nowrap ${activeTab === 'questions'
                                    ? 'border-forest-green text-gray-900'
                                    : 'border-transparent text-gray-400 hover:text-gray-600'
                                    }`}
                            >
                            ...
                            {activeTab === 'questions' && (
                                <div>
                                    <div className="flex items-center justify-between mb-8">
                                        <h3 className="text-xl font-bold text-gray-900 uppercase">Questions & Réponses</h3>
                                        {!showQuestionModal && (
                                            <button
                                                onClick={() => authenticated ? setShowQuestionModal(true) : navigate('/mon-compte')}
                                    ...
                                    <div className="space-y-8">
                                        {questionsLoading ? (
                                            ...
                                            questions.map((q) => (
                                                <div key={q.id} className="border-b border-gray-100 pb-8 last:border-0">
                                                    <div className="flex items-start gap-4">
                                                        <div className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 font-bold">Q</div>
                                                        <div className="flex-1">
                                                            <div className="flex justify-between items-baseline mb-2">
                                                                <span className="font-bold text-gray-900 text-sm">{q.user?.name || 'Utilisateur'}</span>
                                                            ...
                                                            {q.answer ? (
                                                                <div className="bg-gray-50 p-4 rounded-lg flex gap-4">
                                                                    <div className="w-8 h-8 rounded-full bg-forest-green flex items-center justify-center text-white font-bold text-xs">A</div>
                                                                    <div>
                                                                        <div className="font-bold text-forest-green text-xs uppercase mb-1">Réponse de la boutique</div>
                                                                        <p className="text-gray-600 text-sm leading-relaxed">{q.answer}</p>
                                                                    </div>
                                                                </div>
                                                            ) : (
                                                                <div className="text-xs text-gray-400 italic">En attente de réponse...</div>
                                                            )}
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="text-center py-12 px-6 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200">
                                                ...
                                                <p className="text-sm text-gray-400 mt-2">N'hésitez pas à poser la première question !</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
                        ...
                        <div className="bg-white rounded-2xl w-full max-w-lg p-8 shadow-2xl animate-in fade-in zoom-in duration-200">
                            ...
                            {!authenticated ? (
                                <div className="text-center py-8">
                                    <p className="mb-6 text-gray-600">Vous devez être connecté pour poser une question.</p>
                                    <button
                                ...
                                <form onSubmit={handleQuestionSubmit}>
                                    <div className="mb-6">
                                        <label className="block text-xs font-bold text-gray-700 mb-2 uppercase tracking-wide">Votre question</label>
                                        <textarea
                                            value={questionForm}
