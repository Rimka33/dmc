        ...
        <div className="max-w-7xl mx-auto">
          {ordersLoading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 animate-in fade-in slide-in-from-bottom-4 duration-700">
              {orders.map((order) => (
                ...
                >
                  ...
                  {/* Status Badge */}
                  <span
                    className={`absolute top-3 right-3 px-2 py-1 rounded-lg text-[9px] font-bold uppercase z-10 ${
                  ...
                  <div className="flex items-start justify-between mb-3 relative z-10">
                    <div>
                      ...
                      <h3 className="text-xs font-black text-gray-900 uppercase break-words">
                        #{order.order_number}
                      </h3>
                    </div>
                  ...
                  <div className="mb-3 relative z-10">
                    ...
                    <div className="flex items-center gap-1.5 flex-wrap">
                      {order.items?.slice(0, 4).map((item, idx) => (
                        <div
                          key={idx}
                          className="w-8 h-8 bg-gray-50 rounded-lg border border-gray-200 p-0.5 relative group/item flex-shrink-0"
            ...
            <div className="bg-white rounded-[3rem] p-24 text-center shadow-2xl shadow-gray-200/50 border border-gray-100 animate-in zoom-in duration-500">
              ...
              <p className="text-gray-500 font-bold mb-12 max-w-sm mx-auto">
                Vous n'avez pas encore passé de commande chez DMC. Découvrez notre catalogue pour
                commencer !
              </p>
              <Link
                to="/shop"
                className="inline-flex items-center gap-3 px-10 py-5 bg-gray-900 text-white font-black text-[11px] uppercase tracking-[0.2em] rounded-2xl hover:bg-forest-green transition-all shadow-2xl hover:shadow-forest-green/20"
              >
