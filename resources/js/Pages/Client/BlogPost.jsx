    ...
    const fetchPost = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                if (postData.content && !postData.content.includes('<p>') && !postData.content.includes('<br>')) {
                ...
                <section className="py-20 bg-gray-50 border-t border-gray-100">
                    <div className="container mx-auto px-4">
                        <div className="flex flex-col md:flex-row items-end justify-between gap-6 mb-12 max-w-6xl mx-auto">
                            ...
                            <Link to="/blog" className="text-xs font-black text-forest-green uppercase tracking-widest hover:underline whitespace-nowrap">
                                Voir tout le blog →
                            </Link>
                        </div>
